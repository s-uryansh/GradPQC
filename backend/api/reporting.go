...
func HandleDownloadReport(w http.ResponseWriter, r *http.Request) {
	...
	switch format {
	case "json":
		data, err = os.ReadFile("../frontend/apps/web/public/cbom_report.json")
		filename = "cbom_report.json"
		mimeType = "application/json"
	case "excel":
		data, err = os.ReadFile("../frontend/apps/web/public/cbom_report.xlsx")
	...
	if err != nil {
		http.Error(w, "Report file not found. Run a scan first to generate reports.", http.StatusNotFound)
		return
	}
...
func dispatchScheduledReport(sr scheduledRow) error {
	data, err := os.ReadFile("../frontend/apps/web/public/cbom_report.json")
	if err != nil {
		return fmt.Errorf("report file not found (run a scan first): %w", err)
	}
